...
def main():
    ...
    model_path = os.path.join(BASE_DIR, "coral.pth")
    test_path = os.path.join(
        PROJECT_ROOT,
        "UM_DSI_DB_v1.0.0_lite/UM_DSI_DB_v1.0.0_lite/data/site_surveys/2020-02-19/test.csv"
    )
    ...
    model = CORALNet(
        ...
        p_drop=saved_args.get("dropout", 0.2),
    ).to(device)
